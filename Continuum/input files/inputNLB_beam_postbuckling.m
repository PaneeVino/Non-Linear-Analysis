function INPUT = inputNLB_beam_postbuckling( type, nltype )
%
% INPUT = inputNLB_beam_postbuckling( type )
%
% Input file for postbuckling analysis of thin and thick beams
...
INPUT.solver       = 'Newton'; % choose between 'Riks' and 'Newton'
INPUT.lambda_max   = 1.;
INPUT.dlambda0     = .01;
INPUT.norm_res_max = 1e-5;
INPUT.nitermax     = 250;
%
INPUT.Delta_L0      = 0.2; % only for arc-length (ignored with NR)
INPUT.nincrmax     = 500;
